          ...
          <div v-if='etablissement.etatAdministratifEtablissement === "A"'> <!-- Toujours Actif -->
            ...
            <div class="card card-body col-sm;  " v-if="etablissement.enseigne1Etablissement"> <!-- Possède un nom -->
                ...
                <div class="d-flex flex-wrap align-items-center" style="width: 18rem; height: 347px;">
                    ...
                    <img v-else-if="etablissement.enseigne1Etablissement === 'PROXI'" class="card-img-top" src="../images/Proxi_logo_2012.png" alt="Card image cap">
                    ...
                    <img v-else-if="etablissement.enseigne1Etablissement === 'COOP'" class="card-img-top" src="../images/og-default-img.jpg" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'MARCHE PLUS'" class="card-img-top" src="../images/Logo_Marché_Plus.jpg" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'FRANPRIX'" class="card-img-top" src="../images/Logo_Franprix_2015.png" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === '8 A HUIT'" class="card-img-top" src="../images/AAAFXCOCFXLX-C30001.gif.png" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'MUTEVELLI'" class="card-img-top" src="../images/index.jpeg" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'MUTEVELLI MARKET'" class="card-img-top" src="../images/index.jpeg" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'MUTEVELLI SUPERMARKET'" class="card-img-top" src="../images/index.jpeg" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'SIMPLY MARKET'" class="card-img-top" src="../images/1200px-Logo_Simply_Market_2012.svg.png" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'SUMA'" class="card-img-top" src="../images/index2.jpeg" alt="Card image cap">
                    <img v-else-if="etablissement.enseigne1Etablissement === 'ATAC'" class="card-img-top" src="../images/index3.png" alt="Card image cap">
